...
I learned in my algorithms class that dynamic programming is an elegant approach to finding a solution to the Knapsack problem. So, I implemented a 3D-DP algorithm to choose my team for me!
